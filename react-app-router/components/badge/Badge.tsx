export default function Badge({
    ...
    switch (color) {
        ...
        case 'rose':
            ...
            break;
        case 'pink':
            innerClassName += ' bg-pink-400/15 text-pink-700 group-data-hover:bg-pink-400/25 dark:bg-pink-400/10 dark:text-pink-400 dark:group-data-hover:bg-pink-400/20';
            break;
        default:
            innerClassName += ' bg-zinc-600/10 text-zinc-700 group-data-hover:bg-zinc-600/20 dark:bg-white/5 dark:text-zinc-400 dark:group-data-hover:bg-white/10';
            break;
